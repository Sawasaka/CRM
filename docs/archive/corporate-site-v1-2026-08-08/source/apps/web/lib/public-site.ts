...
export const publicSiteTitle = `${companyName}｜野球メディア・GTM・マーケティング基盤`

export const publicSiteDescription = `${companyName}は、中学硬式野球メディア「コーシキベース」の運営と、Go-to-Market（GTM）設計・マーケティング基盤設計を通じて、現場の挑戦を継続的な成長につなげます。`
...
const gtmServiceId = `${publicSiteUrl}/services/gtm#service`
const marketingServiceId = `${publicSiteUrl}/services/marketing-infrastructure#service`
