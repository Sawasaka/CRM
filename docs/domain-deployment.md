...
- 本番デプロイ: `https://rookiesmart-bytmt2xu2-sawasakas-projects.vercel.app`
- Vercel deployment ID: `dpl_B2fmP2EkrC6fKqca6WuPMECAS7sD`
- 直前の本番ロールバック先: `https://rookiesmart-helmjfm2z-sawasakas-projects.vercel.app`
