...
const SAMPLE_ADMIN_REQUESTS: AdminFeatureRequest[] = [
  {
    ...
    tenantPlan: 'PRO',
    requesterName: '田中 健太',
    requesterEmail: 'tanaka@sample.co.jp',
    title: '売上レポート改修(部署別フィルター追加)',
    description:
      '売上レポート画面に部署別のフィルター項目を追加してほしい。\n部門別マージン率の集計ロジックも実装してほしい。Excelエクスポートも対応希望。',
    status: 'submitted',
    estimation: {
      workHours: 6,
      verifyHours: 3,
  ...
  },
  {
    ...
    tenantPlan: 'Standard',
    requesterName: '鈴木 美咲',
    requesterEmail: 'suzuki@growth.jp',
    title: 'Slack通知の自動送信',
    description:
    ...
    amount: 50000,
    createdAt: '2026-05-04T14:15:00',
  },
  {
    id: 'r3',
    tenantId: 'tenant_003',
    tenantName: 'フューチャーテック株式会社',
    tenantPlan: 'PRO',
    requesterName: '佐藤 大輔',
    requesterEmail: 'sato@futuretech.co.jp',
    title: 'AI議事録の感情分析機能',
    description:
      '議事録から顧客の感情(肯定的・否定的・中立)を分析してダッシュボードに可視化したい。会議ごとの感情スコアを記録し、時系列で変化を追えるようにしてほしい。',
    status: 'in_progress',
    estimation: {
      workHours: 12,
      verifyHours: 5,
      ...
      finalAmount: 250000,
      confidence: 'medium',
      rationale: '新規ML処理を含む実装。LLMでの感情分析と時系列可視化UI。複雑度中。',
    },
    amount: 250000,
    createdAt: '2026-04-28T11:00:00',
    reviewedAt: '2026-04-29T10:30:00',
  },
  {
    id: 'r4',
    tenantId: 'tenant_001',
    ...
    requesterName: '田中 健太',
    requesterEmail: 'tanaka@sample.co.jp',
    title: 'パイプラインのKPIダッシュボード',
    description: 'パイプラインに対するKPIを表示するダッシュボードを別画面で。',
    status: 'completed',
    estimation: {
      workHours: 8,
      verifyHours: 3,
      ...
      finalAmount: 160000,
      confidence: 'high',
      rationale: '既存データから派生する画面追加。既存パターンで実装可能。',
    },
    amount: 160000,
    createdAt: '2026-04-15T08:20:00',
    reviewedAt: '2026-04-30T17:00:00',
  },
  {
    id: 'r5',
    tenantId: 'tenant_004',
    tenantName: 'スタートアップABC',
    tenantPlan: 'Standard',
    requesterName: '高橋 理恵',
    requesterEmail: 'takahashi@abc-startup.com',
    title: '無理難題なプロジェクト管理機能',
    description: '何でもできる完全自動化のプロジェクト管理',
    status: 'rejected',
    estimation: {
      workHours: 5,
      verifyHours: 2,
      ...
      finalAmount: 110000,
      confidence: 'low',
      rationale: '要件が抽象的。詳細を追記いただく必要があります。',
    },
    amount: 110000,
