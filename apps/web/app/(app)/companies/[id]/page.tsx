...
export default async function CompanyDetailPage({
  ...
  if (isAbmUuid(id)) {
    ...
    const raw = abm ? toRawFromAbm(abm) : null
    // 法人番号で Prisma 側の取引・コンタクトを引っ張る
    let withCrm: (typeof raw & { deals?: unknown; contacts?: unknown }) | null = raw
    if (raw && abm?.company.corporate_number) {
    ...
    return <CompanyDetailClient id={id} initialData={withCrm as never} />
  }
