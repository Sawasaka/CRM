    ...
    <div className="mx-auto max-w-6xl px-6 py-16">
      <div className="grid md:grid-cols-12 gap-10">
        ...
        <div className="md:col-span-8 grid grid-cols-2 sm:grid-cols-4 gap-6 text-sm">
          {[
            ...
            <div key={i}>
              <div className="font-semibold uppercase tracking-[0.14em] text-[0.72rem] text-[#7e7c83]">
                {g.h}
              </div>
              <ul className="mt-4 space-y-2 text-[#9b99a0]">
                {g.l.map((x) => (
                  <li key={x}>
                    <a href="#" className="hover:text-aurora">
                      {x}
                    </a>
                  </li>
                ))}
      ...
      >
        ...
        <div className="flex flex-wrap gap-x-5 gap-y-2">
          ...
          <a href="/legal/privacy" className="hover:text-aurora">
            Privacy
          </a>
          <a href="/legal/ai-policy" className="hover:text-aurora">
            AI Policy
          </a>
          <a href="/legal/cookie" className="hover:text-aurora">
            Cookie
          </a>
          <a href="/legal/tokushoho" className="hover:text-aurora">
            特定商取引法
          </a>
        </div>
      </div>
