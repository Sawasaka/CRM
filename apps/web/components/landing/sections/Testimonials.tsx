    ...
    <div className="relative mx-auto max-w-6xl px-6 py-24 md:py-32">
      ...
      <div
        ...
        style={{
          ...
          boxShadow:
            '0 24px 60px -20px rgba(171,199,255,0.32), 0 0 0 1px rgba(171,199,255,0.08)',
        }}
      >
        <div className="rounded-[22px] bg-dusk fo-glass-rim p-8 md:p-12 relative overflow-hidden">
          ...
          <div className="relative flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-8">
            <div className="flex items-center gap-3">
              ...
              >
                <span className="w-1.5 h-1.5 rounded-full bg-amber animate-pulse" style={{ boxShadow: '0 0 6px #ffcf4a' }} />
                PARTNERSHIP
              </span>
            </div>
            <div className="flex items-center gap-4">
              ...
              <div
                ...
                style={{
                  ...
                  boxShadow: 'inset 0 0 0 1px rgba(171,199,255,0.20), 0 4px 14px -4px rgba(0,0,0,0.25)',
                }}
              >
                <Image
